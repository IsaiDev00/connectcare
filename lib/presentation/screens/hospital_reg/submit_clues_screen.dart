...
class _SubmitCluesScreen extends State<SubmitCluesScreen> {
  ...
  Future<void> _analyzeFile() async {
    ...
    try {
      // Verificar si los bytes del archivo están disponibles
      if (pickedFile!.bytes == null) {
        throw Exception(
            "No se pudieron obtener los bytes del archivo seleccionado.");
      }

      // Cargar la imagen utilizando la biblioteca 'image'
      img.Image? originalImage = img.decodeImage(pickedFile!.bytes!);
